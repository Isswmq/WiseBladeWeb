(() => {
  ...
  function ne({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          (o.find(ie(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          o.find(ie(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let t;
      ...
      "custom" === s.type && s.renderCustom
        ? (o.html(s.renderCustom(e, c + 1, p)), i("paginationRender", o[0]))
  ...
  function re({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function l() {
      ...
      function p(e) {
        return l ? w(e).attr("data-swiper-slide-index") : w(e).index();
      }
      if (
        ("auto" === d && (d = 0), r || (r = !0), e.params.watchSlidesProgress)
      )
        t.children(`.${s.slideVisibleClass}`).each((e) => {
          a(l ? w(e).attr("data-swiper-slide-index") : w(e).index());
        });
    ...
    function o() {
      ...
      const s = e.params.lazy.scrollingElement
          ? w(e.params.lazy.scrollingElement)
          : w(t),
        i = s[0] === t,
      ...
      u ? (l(), s.off("scroll", o, f)) : n || ((n = !0), s.on("scroll", o, f));
    }
    s("beforeInit", () => {
  ...
  window.addEventListener("load", function (e) {
    le(),
      document.querySelector(".advantages-page__slider") &&
        new se(".advantages-page__slider", {
          modules: [ne, re, ae],
          ...
          preloadImages: !1,
          lazy: { loadPrevNext: !0 },
          pagination: { el: ".advantages-page__controll", clickable: !0 },
          on: {
            init: function () {
              document
                .querySelectorAll(
                  ".advantages-page__controll .swiper-pagination-bullet",
                )
                .forEach((e, t) => {
                  e.innerHTML = `${t + 1}`;
                });
  ...
  if (
    ...
    window.addEventListener("scroll", function (e) {
      ...
      0 === t ? s.classList.remove("_active") : s.classList.add("_active");
    }),
